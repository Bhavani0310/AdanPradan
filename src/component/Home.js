          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                <h5>
                  <strong>
                    AdanPradhan is a workshop booking platform that connects
                    students with affordable workshops.{" "}
                  </strong>
                  You can browse and select workshops based on your interests
                  and location. Colleges and institutions can also list their
                  workshops on our platform.
                </h5>
              </div>
            </div>
          </div>
